...
function engelsystem_email_to_user($recipient_user, $title, $message, $not_if_its_me = false) {
  ...
  $message = sprintf(_("Hi %s,"), $recipient_user['Nick']) . "\n\n" . _("here is a message for you from the JCF Helfersystem:") . "\n\n" . $message . "\n\n" . _("This email is autogenerated and has not to be signed. You got this email because you are registered in the Helfersystem.");
