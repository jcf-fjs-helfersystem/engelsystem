...
function user_settings_main($user_source, $enable_tshirt_size, $tshirt_sizes) {
  global $enable_tshirt_size, $enable_dect, $enable_jabber, $enable_planned_arrival_date, $enable_emailcheckbox, $enable_Hometown, $enable_description_jobs, $enable_age, $enable_phone;
  $valid = true;
  ...
  if ($enable_planned_departure_date) {
